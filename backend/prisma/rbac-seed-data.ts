...
const PERMISSIONS_BY_ROLE: Record<string, PermissionSeed[]> = {
  super_admin: [
    ...
    { module: 'phases', action: 'view', recordScope: 'all' },
    { module: 'phases', action: 'create', recordScope: 'all' },
    { module: 'phases', action: 'edit', recordScope: 'all' },
    ...
    { module: 'tasks', action: 'create', recordScope: 'all' },
  ...
  pm: [
    ...
    { module: 'phases', action: 'view', recordScope: 'own_projects' },
    { module: 'phases', action: 'create', recordScope: 'own_projects' },
    { module: 'phases', action: 'edit', recordScope: 'own_projects' },
    ...
    { module: 'tasks', action: 'create', recordScope: 'own_projects' },
    ...
    { module: 'team', action: 'approve', recordScope: 'own_projects' },
  ...
  team_lead: [
    ...
    { module: 'phases', action: 'view', recordScope: 'team' },
    { module: 'phases', action: 'create', recordScope: 'team' },
    { module: 'phases', action: 'edit', recordScope: 'team' },
    ...
    { module: 'tasks', action: 'create', recordScope: 'team' },
  ...
  finance: [
    ...
    { module: 'phases', action: 'view', recordScope: 'department' },
  ...
  hr: [
    ...
    { module: 'team', action: 'approve', recordScope: 'department' },
    { module: 'reports', action: 'view', recordScope: 'department' },
  ],
  sales: [
    { module: 'notifications', action: 'view', recordScope: 'all' },
  ...
  client: [
    ...
    { module: 'phases', action: 'view', recordScope: 'shared' },
