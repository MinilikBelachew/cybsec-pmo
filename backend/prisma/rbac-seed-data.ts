...
const PERMISSIONS_BY_ROLE: Record<string, PermissionSeed[]> = {
  super_admin: [
    ...
    { module: 'financials', action: 'view_rates', recordScope: 'all' },
    { module: 'reports', action: 'view', recordScope: 'all' },
    { module: 'reports', action: 'export', recordScope: 'all' },
    { module: 'reports', action: 'approve', recordScope: 'all' },
    { module: 'reports', action: 'manage', recordScope: 'all' },
  ...
  pm: [
    ...
    { module: 'reports', action: 'export', recordScope: 'own_projects' },
    { module: 'reports', action: 'approve', recordScope: 'own_projects' },
    { module: 'reports', action: 'manage', recordScope: 'own_projects' },
  ...
  // DEF-P1-088 — SDM = PM modules, all projects (not named-PM only).
  sdm: [
    { module: 'notifications', action: 'view', recordScope: 'all' },
    { module: 'notifications', action: 'manage', recordScope: 'all' },
    { module: 'projects', action: 'view', recordScope: 'all' },
  ...
  finance: [
    ...
    { module: 'financials', action: 'view_rates', recordScope: 'department' },
    { module: 'reports', action: 'view', recordScope: 'department' },
    { module: 'reports', action: 'export', recordScope: 'department' },
