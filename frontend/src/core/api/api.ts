...
export const api = createApi({
  ...
  tagTypes: ["User", "Auth", "Permissions", "Profile", "Users", "Projects", "Departments", "Currencies","Customers", "ProjectManagers", "Tasks", "Phases", "Milestones", "Audit", "Roles", "Settings", "Notifications", "ProjectTeam"],
