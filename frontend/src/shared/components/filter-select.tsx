  ...
  return (
    ...
    >
      <PopoverTrigger
        ...
        disabled={disabled}
        className={cn(
          "flex h-7 w-fit min-w-[150px] max-w-[min(100%,280px)] items-center justify-between gap-1.5 rounded-[min(var(--radius-md),10px)] border border-input bg-transparent py-1 pr-2 pl-2.5 text-sm transition-colors outline-none select-none",
        ...
        title={selected?.label ?? noneLabel}
      >
        <span
          className={cn(
      ...
      <PopoverContent
        align="start"
        side="bottom"
        className="w-72 max-w-[min(100vw-2rem,18rem)] overflow-hidden p-0"
      >
        {searchable ? (
